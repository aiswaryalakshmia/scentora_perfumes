...
class OrderAddress(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="order_addresses"
    )
...
class Order(models.Model):
    ...
    order_address = models.ForeignKey(
        OrderAddress, on_delete=models.SET_NULL, null=True
    )
...
class Payment(models.Model):
    ...
    order = models.OneToOneField(
        Order, on_delete=models.CASCADE, related_name="payment_detail"
    )
...
class Coupon(models.Model):
    ...
    maximum_redeem = models.DecimalField(
