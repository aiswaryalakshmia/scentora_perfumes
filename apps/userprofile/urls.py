...
urlpatterns = [
    ...
    path(
        "profile/addressbook/delete/<int:address_id>",
        views.delete_address,
        name="delete_address",
    ),
    path(
        "profile/address_book/edit/<int:address_id>",
        views.edit_address,
        name="edit_address",
    ),
    ...
    path(
        "profile/my-orders/<int:order_id>/invoice/",
        views.download_invoice,
        name="download_invoice",
    ),
    path(
        "profile/my-orders/<int:order_id>/cancel/",
        views.cancel_order,
        name="cancel_order",
    ),
    path(
        "profile/my-orders/<int:order_id>/cancel-item/<int:item_id>/",
        views.cancel_order_item,
        name="cancel_order_item",
    ),
    path(
        "profile/my-orders/<int:order_id>/return/",
        views.return_order,
        name="return_order",
    ),
    path(
        "profile/my-orders/<int:order_id>/item/<int:item_id>/return/",
