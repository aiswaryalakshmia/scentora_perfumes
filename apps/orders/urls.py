...
urlpatterns = [
    ...
    path(
        "admin-panel/orders/<int:order_id>/status/",
        views.update_order_status,
        name="update_order_status",
    ),
    path(
        "admin-panel/orders/<int:order_id>/items/<int:item_id>/status/",
        views.update_item_status,
        name="update_item_status",
    ),
    path(
        "admin-panel/orders/<int:order_id>/return/",
        views.handle_return_request,
        name="handle_return_request",
    ),
    path(
        "admin-panel/orders/<int:order_id>/item/<int:item_id>/return/",
        views.handle_item_return_request,
        name="handle_item_return_request",
    ),
    path(
    ...
    path(
        "payment/failure/<int:order_id>/", views.payment_failure, name="payment_failure"
    ),
    ...
    path(
        "admin-panel/coupons/<int:coupon_id>/toggle/",
        views.toggle_coupon_status,
        name="toggle_coupon_status",
    ),
    path(
        "admin-panel/coupons/<int:coupon_id>/delete/",
        views.delete_coupon,
        name="delete_coupon",
    ),
    path("admin-panel/sales-report/", views.sales_report, name="sales_report"),
    path(
        "admin-panel/sales-report/pdf/", views.sales_report_pdf, name="sales_report_pdf"
    ),
    path(
        "admin-panel/sales-report/excel/",
